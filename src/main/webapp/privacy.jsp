                ...
                <div class="col-md-12">
                    <div class="error-wrapper text-center">
                        ...
                        <div class="titleh4">
                            ...
                            <p>Ngoài thông tin cá nhân, còn có các thông tin liên quan đến sản phẩm, dịch vụ như:</p>
                            <ul>
                                <li>Sản phẩm: mô tả, mẫu mã, phân loại, yêu cầu chất lượng, xuất sứ sản phẩm…
                                </li>
                                <li>Số lượng: tính theo đơn vị mét / viên / thùng
                                </li>
                                <li>Thời gian: Thời gian giao nhận đơn hàng
                                </li>
                            </ul>
