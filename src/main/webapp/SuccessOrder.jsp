                ...
                <div class="content-box-row content-box-row-padding">
                  <div class="section-content">
                    <div class="section-content-column">
                      ...
                      <h3>Phương thức thanh toán</h3>${order.paymentMethodId == 1002252882? 'Thanh toán tiền mặt khi giao hàng (COD)': order.paymentMethodId == 1002252884 ? 'Thanh toán chuyển khoản qua ngân hàng': 'Ví Momo'}
                      <p></p>
                    </div>
                  </div>
                </div>
          ...
          <div class="step-footer">
            ...
            <p class="step-footer-info">
              ...
              <span>
                    ...
                    <a href="mailto:tilemarket2022@gmail.com">Liên hệ chúng tôi</a>
                  </span>
            </p>
          </div>
        </div>
