...
<!-- saved from url=(0072)https://moho.com.vn/checkouts/1b7b30a4b6314b9dba8d53f5729e1146/thank_you -->
<html
    ...
    <div class="wrap">
        <div class="order-summary-toggle-inner">
            ...
            <div
                    ...
                    data-checkout-payment-due-target="${order.totalPrice}"
            >
                <span class="total-recap-final-price">${order.totalPrice}</span>
            </div>
        </div>
    </div>
</button>
        ...
        <div class="sidebar sidebar-second">
            <div class="sidebar-content">
                <div class="order-summary">
                    <div class="order-summary-sections"></div>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <td class="product-image">
                                            <div class="product-thumbnail">
                                                ...
                                                <span class="product-thumbnail-quantity"
                                                      aria-hidden="true">${quantity}</span>
                                            </div>
                                        </td>
                        ...
                        >
                          ...
                          <span class="order-summary-emphasis"
                            ...
                            <fmt:formatNumber type="currency" currencySymbol="" minFractionDigits="0"
                              ...
                              <span class="applied-reduction-code-information">${voucher.voucherCode}</span>
                                        ...
                                        <td class="total-line-price">
                            <span class="order-summary-emphasis"
                                  data-checkout-discount-amount-target="${voucher.discount}">- <fmt:formatNumber
                                    type="currency"
                                    currencySymbol=""
                                    minFractionDigits="0"
                          ...
                          >
                            <fmt:formatNumber type="currency"
                                ...
                                <c:set var="totalAmount" value="${order.totalPrice}"/>
                                ...
                                <tr class="total-line">
                                    ...
                                    <td class="total-line-name payment-due">
                                        ...
                                        <span class="payment-due-price"
                                              data-checkout-payment-due-target="${totalAmount}">
                            <fmt:formatNumber type="currency"
                                              currencySymbol=""
                                              minFractionDigits="0"
                ...
                <div>
                                ...
                                <div class="content-box-row content-box-row-padding">
                                    <div class="section-content">
                                        <div class="section-content-column">
                                            ...
                                            <h3>Phương thức thanh
                                                toán</h3>${order.paymentMethodId == 1002252882? 'Thanh toán tiền mặt khi giao hàng (COD)': order.paymentMethodId == 1002252884 ? 'Thanh toán chuyển khoản qua ngân hàng': 'Ví Momo'}
                                            <p></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="step-footer">
                        ...
                        <p class="step-footer-info">
                            ...
                            <span>
                    Qúy khách cần hỗ trợ?<a href="mailto:tilemarket2022@gmail.com">Liên hệ chúng tôi</a>, <a href="#" id="print-order">In hóa đơn</a>
                  </span>
                        </p>
                    </div>
                </div>
