...
<head>
    ...
    <link href="${pageContext.request.contextPath}/admin/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet"
          media="screen">
    <link href="${pageContext.request.contextPath}/admin/vendors/easypiechart/jquery.easy-pie-chart.css"
        ...
        <div class="span9" id="content">
                    ...
                    <div class="navbar-inner">
                        <ul class="breadcrumb">
                            ...
                            <i class="icon-chevron-right show-sidebar" style="display:none;"><a href='#'
                                                                                                ...
                                                                                                rel='tooltip'>&nbsp;</a></i>
                            <li>
                                <a href="#">Thông tin chung</a> <span class="divider">/</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">Thống kê</div>
                    </div>
                    <div class="block-content collapse in">
                        <div class="span3">
                            <div class="chart" data-percent="73">73%</div>
                            <div class="chart-bottom-heading"><span class="label label-info">Lượt truy cập</span>

                            </div>
                        </div>
                        <div class="span3">
                            <div class="chart" data-percent="53">53%</div>
                            <div class="chart-bottom-heading"><span class="label label-info">Lượt xem</span>

                            </div>
                        </div>
                        <div class="span3">
                            <div class="chart" data-percent="83">83%</div>
                            <div class="chart-bottom-heading"><span class="label label-info">Tài khoản</span>

                            </div>
                        </div>
                        <div class="span3">
                            <div class="chart" data-percent="13">13%</div>
                            <div class="chart-bottom-heading"><span class="label label-info">Đơn hàng</span>
            ...
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Tài khoản</div>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Liên hệ</div>
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">Sản phẩm bán chạy</div>
