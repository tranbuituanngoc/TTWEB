        ...
        <div class="slider_box">
            <div class="slider-wrapper theme-default">
                ...
                <div id="slider" class="nivoSlider">
                    <a href="ProductLists?page=1"><img src="img\slider\5.jpg" data-thumb="img/slider/5.jpg" alt="" title="#htmlcaption"></a>
                    <a href="ProductLists?page=1"><img src="img\slider\6.jpg" data-thumb="img/slider/6.jpg" alt="" title="#htmlcaption2"></a>
                </div>
                <!-- Slider Background  Image Start-->
            </div>
        </div>
