                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="rolename"
                                                       placeholder="Tên quyền" value="${r.role_name}" name="role_name">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10 mt-10">
                                                <div class="checkbox">
                                                    <c:if test="${r.user_permission ==1}">
                                                        <input type="checkbox" id="gridCheck1" checked name="user_permission">
                                                    </c:if>
                                                    <c:if test="${r.user_permission !=1}">
                                                ...
                                                <div class="checkbox">
                                                    <c:if test="${r.order_permission ==1}">
                                                        <input type="checkbox" id="gridCheck2" checked name="order_permission">
                                                    </c:if>
                                                    <c:if test="${r.order_permission !=1}">
                                                ...
                                                <div class="checkbox">
                                                    <c:if test="${r.cart_permission ==1}">
                                                        <input type="checkbox" id="gridCheck3" checked name="cart_permission">
                                                    </c:if>
                                                    <c:if test="${r.cart_permission !=1}">
                                                ...
                                                <div class="checkbox">
                                                    <c:if test="${r.product_permission ==1}">
                                                        <input type="checkbox" id="gridCheck4" checked name="product_permission">
                                                    </c:if>
                                                    <c:if test="${r.product_permission !=1}">
                                                ...
                                                <div class="checkbox">
                                                    <c:if test="${r.shipping_address_permission ==1}">
                                                        <input type="checkbox" id="gridCheck5" checked name="shipping_address_permission">
                                                    </c:if>
                                                    <c:if test="${r.shipping_address_permission !=1}">
                                                        <input type="checkbox" id="gridCheck5" name="shipping_address_permission">
                                                    </c:if>
                                                ...
                                                <div class="checkbox">
                                                    <c:if test="${r.role_permission ==1}">
                                                        <input type="checkbox" id="gridCheck6" checked name="role_permission">
                                                    </c:if>
                                                    <c:if test="${r.role_permission !=1}">
